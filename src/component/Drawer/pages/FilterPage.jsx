...
const FilterPage = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full p-6">
      <h2 className="text-2xl font-bold text-gray-800 mb-4">Filter Page</h2>
      <p className="text-gray-600 text-center max-w-md">
        This is the <span className="font-semibold text-blue-600">Filter Page</span> lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempora
